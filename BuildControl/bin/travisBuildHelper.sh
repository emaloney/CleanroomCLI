...
( set -o pipefail && xcodebuild -project CleanroomCLI.xcodeproj -configuration Debug -scheme "CleanroomCLI" -destination "$DESTINATION" -destination-timeout 300 $BUILD_ACTION 2>&1 | tee "CleanroomCLI-$PLATFORM-$OPERATION.log" | xcpretty )
