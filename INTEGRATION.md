...
**This is the `swift-4` branch of CleanroomCLI.** It uses **Swift 4.0** and **requires Xcode 9.0 beta** to compile.
...
Once properly integrated, you can make use of [the API](https://rawgit.com/emaloney/CleanroomCLI/swift-4/Documentation/API/index.html) provided by CleanroomCLI in any Swift file using the statement:
...
Want to learn more about CleanroomCLI? Check out [the README](https://github.com/emaloney/CleanroomCLI/blob/swift-4/README.md) or [the API documentation](https://rawgit.com/emaloney/CleanroomCLI/swift-4/Documentation/API/index.html).
